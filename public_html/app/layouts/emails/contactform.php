...
if(isset($_POST['submitquestion'])) {
    ...
    $section = $_POST['your-section'];
    $question = $_POST['your-question'];

    $to = $adminemail;
    $subject = "FAQ Question From $current_name | Cooper Handling Portal";

    $message = "
        <html style='background-color:#f8f8f8;'>
            <head>
                <title>FAQ Question | Cooper Handling Portal</title>
                    ...
                    <table style='border-spacing:0;width:540px;margin:auto;'>
                        <tr class='header' style='width:200px; margin: auto 0px; text-align:center;'>
                            <td style='border-spacing:0;background:#3695c5;display:block;padding:30px;width:480px;margin: auto 0px;text-align:center;border-radius: 10px 10px 0 0;'>
                                ...
                                <span style='color: #fff; font-family: arial; display:block; font-size: 14pt; line-height: 18px; text-align:center; font-weight:bold;'>FAQ Question!</span>
                            </td>
                        </tr>
