...
survey_all(false);
surveyaverageall($survey_all);

function surveyaverageall($variable) {
    global $excellent;
    $excellent = 0;
    global $good;
    $good = 0;
...
<div class="col-xl-4 col-md-12">
    <div class="card calendar">
        <div class="card-header">
            <strong>Survey Feedback (All Time)</strong>
        </div>
        <div class="card-body">
            <div id="doughnut-chart" data-colors='["#f4f4f4", "#f8aaa6", "#fbb377", "#b6ddad", "#6db461"]' class="e-charts"></div>
        </div>
    </div>
</div>
