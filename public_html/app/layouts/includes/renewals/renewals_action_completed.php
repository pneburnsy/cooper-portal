<?php if (doif_coopereditoronly_query()) { ?>
    <form method="post" class="form-inline">
        <button class="btn btn-edit waves-effect waves-light" type="submit" name="exam_uncomplete" value="<?= $variable[$i]->displayid; ?>">
...
<?php if ( current_user_can('administrator') ) { ?>
    <form method="post" class="form-inline">
        <button class="btn btn-danger waves-effect waves-light" type="submit" name="exam_bin" value="<?= $variable[$i]->displayid; ?>">
