...
function fleet_manager_outstanding($clientname, $clientemail, $clientaccount, $admincc) {

    global $wpdb;

    $to = "$clientemail";
    $subject = "This Weeks ODO Readings Required! | Cooper Handling";

    $message = "
    <html style='background-color:#f8f8f8;'>
    <head>
        <title>$clientaccount ODO Submissions Required | Cooper Handling</title>
        ...
        <table style='border-spacing:0;width:540px;margin:auto;'>
            <tr class='header' style='width:200px; margin: auto 0px; text-align:center;'>
                <td style='border-spacing:0;background:#3695c5;display:block;padding:30px;width:480px;margin: auto 0px;text-align:center;border-radius: 10px 10px 0 0;'>
                    <span style='color: #fff; font-family: arial; display:block; margin-bottom: 10px;font-size: 9pt; line-height: 18px; text-align:center; font-weight:regular;'>$clientaccount</span>
                    <span style='color: #fff; font-family: arial; display:block; font-size: 14pt; line-height: 18px; text-align:center; font-weight:bold;'>ODO Readings Required</span>
                </td>
            </tr>
                    ...
                    <span style='width:100%; text-align:center;'>
                        <span style='border-radius:10px; color:#1e283c; display:block; text-align:center;'>
                            <span style='display:block;font-size: 13px; line-height:20px; margin: 0 auto 10px auto; max-width: 300px; font-weight:500;'>
                                Hi $clientname,
                                <br><br>
                                Please Login and enter your outstanding ODO readings for $clientaccount. Please stay up-to-date with your submissions to ensure your equipment stays within its service schedule.
                                <br><br> 
                                Regards,
                                <br>
                                Cooper Handling.
                            </span>
                            <a href='https://portal.cooperhandling.com/app/page_service_account_submission' style='text-decoration: none;margin: 22px auto 0 auto;display: block;width: fit-content;font-size:13px; text-transform: none; padding: 15px 20px; border-radius:5px; background-color: #3695c5; color: #fff; font-weight: bold;'>Submit ODO Readings</a>
                        </span>
                    </span>
                </td>
            </tr>
    ...
    echo '<br>Email Sent: ' . $clientemail . ' (' . $admincc . ').';
