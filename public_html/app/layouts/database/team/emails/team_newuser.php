...
$to = "$team_email";
$subject = "$current_name Invited You To The Cooper Portal | Cooper Handling";
            ...
            <table style='border-spacing:0;width:540px;margin:auto;'>
                <tr class='header' style='width:200px; margin: auto 0px; text-align:center;'>
                    <td style='border-spacing:0;background:#3695c5;display:block;padding:30px;width:480px;margin: auto 0px;text-align:center;border-radius: 10px 10px 0 0;'>
                        <span style='color: #fff; font-family: arial; display:block; margin-bottom: 10px;font-size: 9pt; line-height: 18px; text-align:center; font-weight:regular;'>Hi $team_firstname,</span>
                        <span style='color: #fff; font-family: arial; display:block; font-size: 14pt; line-height: 18px; text-align:center; font-weight:bold;'>Welcome to Cooper Handling!</span>
                    </td>
                </tr>
                        ...
                        <span style='width:100%; text-align:center;'>
                            <span style='border-radius:10px; color:#1e283c; display:block; text-align:center;'>
                                <span style='display:block;font-size: 13px; line-height:20px; margin: 0 auto 10px auto; max-width: 300px; font-weight:500;'>
                                    $current_name has invited you to their team on the Cooper Handling Portal. You can find your login details below.
                                </span>
                                <span style='display:block;font-size: 13px; line-height:20px; margin:0; font-weight:500;'>
                                    <strong>Username:</strong> $team_email <br>
                                    <strong>Password:</strong> $team_password <br>
                                </span>
                                <a href='https://Cooper Handling.uk/app/dashboard' style='margin: 22px auto 0 auto;display: block;width: fit-content;font-size:13px; text-transform: none; padding: 15px 20px; border-radius:5px; background-color: #3695c5; color: #fff; font-weight: bold;'>Login</a>
                            </span>
                        </span>
                    </td>
                </tr>
