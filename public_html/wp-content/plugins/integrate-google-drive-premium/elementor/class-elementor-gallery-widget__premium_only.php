...
class Gallery_Widget extends Widget_Base {
	...
	public function get_title() {
		return __( 'Photo Gallery', 'integrate-google-drive' );
	}
	...
	public function register_controls() {
		...
		$this->start_controls_section( '_section_module_builder',
			[
				'label' => __( 'Photo Gallery Module', 'integrate-google-drive' ),
		...
		$this->add_control( 'module_data', [
			...
			'render_type' => 'none',
			'default'     => '{"isInit":true,"status":"on","type":"gallery","folders":[],"showFiles":true,"showFolders":true,"moduleWidth": "100%", "moduleHeight": "auto","fileNumbers":-1,"sort":{"sortBy":"name","sortDirection":"asc"},"view":"list","maxFileSize":"","preview":"true","download":true,"displayFor":"everyone","displayUsers":["everyone"],"displayExcept":[]}',
		] );
