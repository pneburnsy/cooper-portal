...
class Download_Widget extends Widget_Base {
	...
	public function register_controls() {
		...
		$this->add_control( 'module_data', [
			...
			'render_type' => 'none',
			'default'     => '{"isInit":true,"status":"on","type":"download","folders":[],"showFiles":true,"showFolders":true,"moduleWidth": "100%", "moduleHeight": "auto","fileNumbers":-1,"sort":{"sortBy":"name","sortDirection":"asc"},"view":"list","maxFileSize":"","preview":"true","download":true,"displayFor":"everyone","displayUsers":["everyone"],"displayExcept":[]}',
		] );
