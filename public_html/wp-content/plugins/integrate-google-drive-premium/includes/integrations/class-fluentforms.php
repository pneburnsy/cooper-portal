	...
	public function generalEditorElement() {
		return [
			'igd_data' => [
				...
				'help_text'        => esc_html__( 'Grab the Shortcode Data via the shortcode builder and copy + paste in this field.', 'integrate-google-drive' ),
				'css_class'        => 'igd-uploader-data',
				'inline_help_text' => '<br/><div class="igd-form-uploader-config-fluentforms"><button type="button" class="igd-form-uploader-trigger igd-btn btn-primary"><i class="dashicons dashicons-admin-generic"></i><span>Configure</span></button></div>
<br />
Configure the uploader field using the module shortcode builder and copy + paste the Shortcode Data in this field. 
',
				'rows'             => 8,
			],
		];
