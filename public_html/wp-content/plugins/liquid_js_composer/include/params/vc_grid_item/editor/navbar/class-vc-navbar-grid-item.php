...
class Vc_Navbar_Grid_Item extends Vc_Navbar {
	...
	public function getControlPreviewTemplate() {
		return '<li>' . '<a href="#" class="vc_btn vc_btn-grey vc_btn-sm vc_navbar-btn" data-vc-navbar-control="preview">' . esc_html__( 'Preview', 'js_composer' ) . '</a>' . '</li>';
	}
	...
	public function getControlEdit() {
		return '<li>' . '<a data-vc-navbar-control="edit" class="vc_icon-btn vc_post-settings" title="' . esc_attr__( 'Grid element settings', 'js_composer' ) . '"><i class="la la-cog"></i>' . '</a>' . '</li>';
	}
	...
	public function getControlSaveBackend() {
		return '<li class="vc_save-backend">' . '<a class="vc_btn vc_btn-sm vc_navbar-btn vc_btn-primary vc_control-save" id="wpb-save-post">' . esc_html__( 'Update', 'js_composer' ) . '</a>' . '</li>';
	}
	...
	public function getControlPreviewItemWidth() {
		$output = '<li class="vc_gitem-navbar-dropdown vc_gitem-navbar-preview-width" data-vc-grid-item="navbar_preview_width"><select data-vc-navbar-control="preview_width">';
		for ( $i = 1; $i <= 12; $i ++ ) {
	...
	public function getControlAnimationList() {
		...
		if ( is_array( $animations ) ) {
			$output .= '<li class="vc_gitem-navbar-dropdown"><select data-vc-navbar-control="animation">';
