...
?>
<div class="vc_ui-panel-window vc_media-xs vc_ui-panel" data-vc-panel=".vc_ui-panel-header-header" data-vc-ui-element="panel-row-layout" id="vc_ui-panel-row-layout">
			...
			<div class="vc_ui-panel-content vc_properties-list vc_edit_form_elements" data-vc-ui-element="panel-content">
				<div class="vc_row vc_ui-flex-row">
					...
					<div class="vc_col-sm-12 vc_column">
						<div class="wpb_element_label_container">
							<div class="wpb_element_label"> <?php esc_html_e( 'Enter custom layout for your row', 'js_composer' ); ?> </div>
							<div class="vc_description_container">
								<span class="vc_description"><?php esc_html_e( 'Change particular row layout manually by specifying number of columns and their size value.', 'js_composer' ); ?></span>
							</div>
						</div>
