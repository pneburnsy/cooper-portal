...
?>
<div class="vc_ui-panel-window vc_templates-panel vc_pages-templates-panel vc_media-xs vc_ui-panel"
	data-vc-panel=".vc_ui-panel-header-header" data-vc-ui-element="panel-pages-templates" id="vc_ui-panel-pages-templates">
	<div class="vc_ui-panel-window-inner">
		...
		vc_include_template( 'editors/popups/vc_ui-header.tpl.php', array(
			'title' => esc_html__( 'Pages', 'js_composer' ),
			...
			<div class="vc_ui-panel-content vc_properties-list"
				...
				<div class="vc_panel-tabs">
					...
					foreach ( $categories_data as $key => $category ) :
						...
						echo '<div class="vc_edit-form-tab vc_row vc_ui-flex-row' . ( $first ? ' vc_active' : '' ) . '"' . ' data-vc-ui-element="panel-edit-element-tab"' . ' data-tab="liquid_page_templates">';
						$templates_block = apply_filters( 'vc_page_templates_render_category', $category );
		...
		<div class="vc_ui-panel-footer-container" data-vc-ui-element="panel-footer">
			<div class="vc_ui-panel-footer"></div>
		</div>
	</div>
</div>
<!--/ temp content -->
