...
?>
<div class="vc_ui-panel-window vc_media-xs vc_ui-panel" data-vc-panel=".vc_ui-panel-header-header" data-vc-ui-element="panel-post-settings" id="vc_ui-panel-post-settings">
				...
				<div class="vc_row">
					...
					<div class="vc_col-sm-12 vc_column">
						<div class="wpb_element_label_container">
							...
							<div class="vc_description_container">
								<span class="vc_description"><?php esc_html_e( 'Enter custom CSS (Note: it will be outputted only on this particular page).', 'js_composer' ); ?></span>
							</div>
						</div>
						<div class="edit_form_line">
