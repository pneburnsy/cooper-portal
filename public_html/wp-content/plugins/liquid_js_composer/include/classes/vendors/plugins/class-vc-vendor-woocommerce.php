...
class Vc_Vendor_Woocommerce {
	...
	public function getAttributeTermsAjax() {
		...
		foreach ( $values as $label => $v ) {
			$param_line .= ' <label class="vc_checkbox-nolabel"><input id="' . $param['param_name'] . '-' . $v . '" value="' . $v . '" class="wpb_vc_param_value ' . $param['param_name'] . ' ' . $param['type'] . '" type="checkbox" name="' . $param['param_name'] . '"' . '> ' . $label . '</label>';
		}
