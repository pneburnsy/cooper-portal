...
class WPBakeryShortCode_VC_Column extends WPBakeryShortCode {
	...
	public function getColumnControls( $controls, $extended_css = '' ) {
		...
		if ( vc_user_access()->part( 'shortcodes' )->checkStateAny( true, 'custom', null )->get() ) {
			$controls_add = '<a class="vc_control column_add vc_column-add" data-vc-control="add" href="#" title="' . $control_title . '"><i class="la la-plus"></i></a>';
		} else {
			$controls_add = '';
		}
		...
		$controls_edit = '<a class="vc_control column_edit vc_column-edit"  data-vc-control="edit" href="#" title="' . __( 'Edit this column', 'js_composer' ) . '"><i class="la la-pen"></i></a>';
		$controls_delete = '<a class="vc_control column_delete vc_column-delete" data-vc-control="delete"  href="#" title="' . __( 'Delete this column', 'js_composer' ) . '"><i class="la la-times"></i></a>';
		...
		if ( is_array( $controls ) && ! empty( $controls ) ) {
			...
			if ( $allAccess ) {
				return $output . $controls_img . $controls_color . $controls_add . $controls_edit . $controls_delete . $controls_end;
			} elseif ( $editAccess ) {
				return $output . $controls_img . $controls_color . $controls_add . $controls_edit . $controls_end;
			}

			return $output . $controls_img . $controls_color . $controls_add . $controls_end;
