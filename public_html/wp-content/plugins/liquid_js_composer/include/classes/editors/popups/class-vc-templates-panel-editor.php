...
class Vc_Templates_Panel_Editor {
	 ...
	 * @since 6.4.1
	 */
	public function renderUIPagesTemplate() {
		vc_include_template( 'editors/popups/vc_ui-panel-pages-templates.tpl.php', array(
			'box' => $this,
		) );
