...
class Vc_Edit_Form_Fields {
	...
	public function renderField( $param, $value ) {
		...
		$output .= '<div class="wpb_element_label_container">';
		$output .= ( isset( $param['heading'] ) ) ? '<div class="wpb_element_label">' . $param['heading'] . '</div>' : '';
		$output .= ( isset( $param['description'] ) ) ? '<div class="vc_description_container"><span class="vc_description">' . $param['description'] . '</span></div>' : '';
		$output .= '</div>';
