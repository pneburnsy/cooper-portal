...
class Vc_Backend_Editor {
	...
	public function registerBackendJavascript() {
		...
		wp_register_script( 'marionettejs', vc_asset_url( 'lib/bower/backbone.marionette.min.js' ), array( 'vc-backend-actions-js' ), WPB_VC_VERSION, true );
		wp_register_script( 'marionette-templatecache', vc_asset_url( 'lib/bower/marionette.templatecache.min.js' ), array( 'marionettejs' ), WPB_VC_VERSION, true );
