...
class R34ICS {
	...
	public function enqueue_scripts() {
		...
		wp_localize_script('ics-calendar', 'r34ics_days_of_week_map', (array)$this->days_of_week_map());
	...
	public function event_description_html($args, $event, $classes=array(), $has_desc=null) {
		...
		if (!empty($has_desc) || !empty($descloc_content)) {
			...
			if ($args['toggle'] === 'lightbox' || (!empty($event['multiday']) && $args['view'] != 'list')) {
			...
			if (in_array('hover_block', $descloc_class) || $args['toggle'] === 'lightbox' || (!empty($event['multiday']) && $args['view'] != 'list')) {
