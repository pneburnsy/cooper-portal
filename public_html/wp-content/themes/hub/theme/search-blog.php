<?php
/**
 * Liquid_SearchBlog class for blog posts page and blog archives
 */

class Liquid_SearchBlog extends LD_Blog {
	...
	public function __construct() {
		$this->atts = array(
			'style' => liquid_helper()->get_option( 'search-blog-style' ),

			'enable_parallax' => liquid_helper()->get_option( 'search-blog-enable-parallax' ),
			'show_meta' => liquid_helper()->get_option( 'search-blog-show-meta' ),
			'meta_type' => liquid_helper()->get_option( 'search-blog-meta-type' ),
			'one_category' => liquid_helper()->get_option( 'search-blog-one-category' ),
			'post_excerpt_length' => liquid_helper()->get_option( 'search-blog-excerpt-length' ),
			'grid_columns' => liquid_helper()->get_option( 'blog-search-columns' ),
